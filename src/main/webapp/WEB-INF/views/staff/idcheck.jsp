<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="global.sesoc.tp.vo.StaffVO" %>
...
//ID 중복 검색폼 확인
function formCheck() {
	if (document.getElementById('searchId').value.length < 2) {
		alert('검색할 ID를 2자 이상 입력하세요.');
		return false;
	}
	return true;
}
...
function idSelect(id) {
	opener.document.getElementById('staffId').value = id;
	this.close();
}
</script>
</head>
